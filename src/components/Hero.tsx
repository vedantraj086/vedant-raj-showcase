...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-hero relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-primary-glow/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="container mx-auto px-6 z-10">
        <div className="text-center animate-fade-in">
          ...
          <div className="flex justify-center gap-6">
            <Button variant="ghost" size="lg" asChild className="group hover:shadow-glow">
              <a 
